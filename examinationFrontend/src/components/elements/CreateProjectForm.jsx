...
const CreateProjectForm = () => {
    ...
    const handleChange = (e) => {
        console.log('Selected value:', e.target.value); // Lägg till denna rad för att logga vad som händer
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                console.log('Failed to create project:', res.status);
            }
        } catch (error) {
        ...
        <section>
            <div className='container'>
                <form onSubmit={handleSubmit}>
                    ...
                    <button className='btn' type='submit'>Skapa</button>
                </form>
            </div>
        </section>
    );
